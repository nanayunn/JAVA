								...
								<div class="d-flex">
									...
									<div class="btn-group">
										...
										<div class="dropdown-menu"
											...
											<a class="dropdown-item" href="ascname.mc">Name, A to Z</a> <a
												class="dropdown-item" href="descname.mc">Name, Z to A</a>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item" href="ascprice.mc">Price, low to
												high</a> <a class="dropdown-item" href="descprice.mc">Price,
												high to low</a>
										</div>
									</div>
								</div>
